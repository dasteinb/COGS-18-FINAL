...
def about_info():
    ...
    about_text_10 = "and innovation, and centering Black joy, we are"
    about_text_11 = "winning immediate improvements in our lives."
...
def actions_info():
    ...
    actions_text_29 = "Sacramento City, AGNT, NAACP, SURJ, HIP, "
    actions_text_30 = "Immigration Brown Berets, and a host of others."
...
def update_sections(position):
    ...
    def expand_screen():
        ...
        screen = pygame.display.set_mode((1400, 870))
